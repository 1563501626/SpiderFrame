...
class X75Spider(manager.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.start_urls = ["http://121.33.200.110:8088/evaluateCompanyResult/load_result_public_list?isShow=1&_search=false&nd=1594169595714&rows=10&page=1&sidx=&sord=desc&companyName=&nowGrade=&companyType=&industry=1"]
        self.url = "http://121.33.200.110:8088/evaluateCompanyResult/load_result_public_list?isShow=1&_search=false&nd=1594169595714&rows=10&page={page}&sidx=&sord=desc&companyName=&nowGrade=&companyType=&industry=1"
        self.total = 0
        self.page = 1
...
if __name__ == '__main__':
    ...
    cmdline.execute('scrapy crawl X--76'.split())
