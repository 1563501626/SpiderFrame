...
class X66Spider(manager.Spider):
    ...
    def __init__(self, pagecount=50, *args, **kwargs):
        ...
        self.post_header = {
            ...
            'Referer': 'http://121.8.226.19/gzswcx/client/credit/EntSyntheticalCredit/getEntSyntheticalCredit.htm?fslx=101',
            'Upgrade-Insecure-Requests': '1',
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 '
                          '(KHTML, like Gecko) Chrome/80.0.3987.122 Safari/537.36'}
        self.post_data = {'fslx': '101',
                          'page': '2',
                          'pageSize': '8',
                          'quarter': '10-01:12-31',
                          'qymc': '',
    ...
    def start_requests(self):
        ...
        url = "http://121.8.226.19/gzswcx/client/credit/EntSyntheticalCredit/getEntSyntheticalCredit.htm"
