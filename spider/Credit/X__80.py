...
class X75Spider(manager.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.data = {
            ...
            'ddlCorpType': '2102001',
            'ddlPeriod': 'c7821dfa-8d07-40ed-93cd-8b397f9aaa3b',
            'ddlGrade': '',
            'txtCorpCode': '',
            'txtCorpName': '',
            'btnQuery': '查询',
...
if __name__ == '__main__':
    ...
    cmdline.execute('scrapy crawl X--80'.split())
