...
class Spider(manager.Spider):
    ...
    total = 0
    cookie = {}
    url = 'http://49.65.0.83/ProjectRegister/DisplayWebs/Ashx/GetSGCreditInfo.ashx'
    ...
    def deal_parse(self, response):
        ...
        for i in data:
            ...
            item['评价年度'] = i['CreditYear']
            item['网站维护代码'] = 'X--115'
            item['信用得分'] = i['CreditScore']
            item['省'] = '江苏'
            item['市'] = '南京'
            item['网站名称'] = '南克市建筑市场监管诚值信思一体化平台'
            item['url'] = 'http://49.65.0.83/ProjectRegister/DisplayWebs/Index_Credit.html'
            yield item


if __name__ == '__main__':
    from manager import run
    run(['Credit', 'X--115', 'w', 1])
