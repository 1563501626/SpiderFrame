...
class X71Spider(manager.Spider):
    ...
    def __init__(self, pagecount=50, *args, **kwargs):
        ...
        self.post_data = ezfuc.struct_data("page=1&count=20&qymc=&qylx=施工企业&szqy=")
...
if __name__ == '__main__':
    ...
    cmdline.execute('scrapy crawl X--71'.split())
